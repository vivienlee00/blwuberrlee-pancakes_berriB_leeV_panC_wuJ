...
var mass_shootings_text = function(shootingsnum){
  svg.append("text")
     .text(shootingsnum + " mass shootings have occurred during this time")
     .attr("x", 75)
     .attr("y", 250)
